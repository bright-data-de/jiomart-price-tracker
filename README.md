...
[![JioMart Price Tracker](https://img.shields.io/badge/JioMart%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/jiomart)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/jiomart)

JioMart-Preisverfolgung in Echtzeit – Reliance's landesweite Lebensmittel- und Einzelhandelsplattform in Indien. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder ein **benutzerdefinierter Scraper**, erstellt mit Bright Data's AI Scraper Builder.

---

## Option 1: Bright Insights - KI-gestützte Preisverfolgung (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/jiomart)** ist Bright Data's vollständig verwaltete Plattform für Retail Intelligence. Keine Scraper zu erstellen, keine Infrastruktur zu warten – nur strukturierte, analysebereite Preisdaten, geliefert an Dashboards, Data Feeds oder Ihre BI-Tools.
...
- ✅ **Verfolgen Sie die Lebensmittelpreisinflation** über Kategorien hinweg auf JioMart
...
> **Ab $250/Monat – [Erhalten Sie ein individuelles Angebot →](https://brightdata.de/products/insights/price-tracker/jiomart)**

---

## Option 2: Erstellen Sie Ihren eigenen JioMart-Scraper

Keine vorgefertigte JioMart-Scraper-API? Kein Problem. Bright Data's **AI Scraper Builder** generiert in nur wenigen Klicks einen benutzerdefinierten JioMart-Scraper — ganz ohne Programmierung.

### Erstellen Sie Ihren JioMart-Scraper in wenigen Minuten

**[Öffnen Sie den JioMart AI Scraper Builder →](https://brightdata.de/products/web-scraper/jiomart)**
...
- Eine **Web Scraper ID** für JioMart (aus dem obigen Build-Schritt)
...
1. **Klonen Sie dieses repository**
   ...
   ```bash
   git clone https://github.com/bright-data-de/jiomart-price-tracker.git
   cd jiomart-price-tracker
   ```
...
3. **Konfigurieren Sie die Zugangsdaten**
   ...
   > **Ihre Web Scraper ID**
   > Fügen Sie die Web Scraper ID aus Ihrem [AI Scraper Builder-Dashboard](https://brightdata.de/products/web-scraper/jiomart)
...
Sobald Ihr JioMart-Scraper erstellt wurde und Ihre Web Scraper ID in `.env` konfiguriert ist, funktioniert die Python-Schnittstelle auf die gleiche Weise:

### 1. Bestimmte Produkte per URL verfolgen

Übergeben Sie eine Liste von JioMart-Produkt-URLs, um strukturierte Preisdaten abzurufen:

```python
from price_tracker import track_prices

urls = [
    "https://www.jiomart.com/products/sample-product",
...
Sammeln Sie alle Produkte von einer JioMart-Kategorieseite:

```python
from price_tracker import discover_by_category

results = discover_by_category(
    "https://jiomart.com/category/example",
    limit=100,
)
```
...
[
  {
    "url": "https://www.jiomart.com/products/sample-product",
    ...
    "rating": 4.5,
    "reviews_count": 1234,
    "images": ["https://jiomart.com/images/product1.jpg"],
...
inputs = [{"url": "https://www.jiomart.com/products/sample-product"}]
...
- 🌟 [JioMart Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/jiomart)
- 🏗️ [Einen JioMart-Scraper erstellen](https://brightdata.de/products/web-scraper/jiomart)
